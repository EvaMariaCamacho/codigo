    ...
    <script src="assets/parallax/js/vendor/bootstrap.min.js"></script>

    <script src="assets/parallax/js/plugins.js"></script>
    <script src="assets/parallax/js/main.js"></script>
